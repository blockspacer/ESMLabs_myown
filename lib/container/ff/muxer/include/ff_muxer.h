        ...
        namespace container
        {
            namespace ff
            {
                namespace v4_2_1
                {
                    ...
                    public:
                        typedef struct _queue_elem_t
                        {
                            ...
                            _queue_elem_t(int size)
                                : type(magnetar::lib::container::ff::v4_2_1::muxer::media_type_t::unknown)
                                , data(nullptr)
                                , size(size)
                                , dts(-1)
                                , cts(-1)
                        ...
                        typedef struct _msg_t
                        {
                            int32_t		msg_type;
                            char		path[MAX_PATH];
                            std::shared_ptr<magnetar::lib::container::ff::v4_2_1::muxer::core::queue_elem_t> msg_elem;
                        } msg_t;

                        typedef struct _media_thread_context_t
                        {
                            char		path[MAX_PATH];
                            magnetar::lib::container::ff::v4_2_1::muxer::core * parent;
                        } media_thread_context_t;

                        core(magnetar::lib::container::ff::v4_2_1::muxer * front);
                        ~core(void);                    
                    ...
                    private:
                        magnetar::lib::container::ff::v4_2_1::muxer *				_front;
                        magnetar::lib::container::ff::v4_2_1::muxer::context_t *	_context;
